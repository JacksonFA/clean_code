...
insert into system.classRoom (level, module, code, capacity, start_date, end_date) values ('EM', '3', 'A', 2, '2021-06-01','2021-12-15'), ('EM', '3', 'B', 2, '2021-05-01','2021-05-30'), ('EM', '3', 'C', 2, '2021-05-01','2021-06-30');